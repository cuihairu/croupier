	...
	rows := []model.PageSpec{
		{
			...
			CategoryKey: "resource", CategoryLabelsJSON: `{"zh-CN":"资源管理","en-US":"Resource"}`,
			CategoryOrder: 1, SpecJSON: `{}`,
		},
		{
			GameID: "demo-game", Env: "development", PageKey: "resource--order",
			CategoryKey: "resource", CategoryLabelsJSON: `{"zh-CN":"资源管理(旧)","en-US":"Resource"}`,
			CategoryOrder: 2, SpecJSON: `{}`,
		},
		{
			GameID: "demo-game", Env: "development", PageKey: "operation--announce",
			CategoryKey: "operation", CategoryLabelsJSON: `{"zh-CN":"运营工具"}`,
			CategoryOrder: 2, SpecJSON: `{}`,
		},
		{
			GameID: "other-game", Env: "development", PageKey: "resource--leaderboard",
			CategoryKey: "resource", CategoryLabelsJSON: `{"zh-CN":"资源"}`,
			CategoryOrder: 1, SpecJSON: `{}`,
		},
		{
			// 无分类页面：不参与迁移
			GameID: "demo-game", Env: "development", PageKey: "uncategorized",
			CategoryKey: "", CategoryLabelsJSON: "", SpecJSON: `{}`,
		},
	}
	for i := range rows {
