...
"@
    $bufGen | Out-File -FilePath "proto\buf.gen.yaml" -Encoding utf8
...
"@
    $bufYaml | Out-File -FilePath "proto\buf.yaml" -Encoding utf8
...
# SDK 配置
$SdkMapping = @{
    "go" = @{ Repo = "croupier-sdk-go"; Name = "Go"; Function = "Sync-GoSdk" }
    "python" = @{ Repo = "croupier-sdk-python"; Name = "Python"; Function = "Sync-PythonSdk" }
    "cpp" = @{ Repo = "croupier-sdk-cpp"; Name = "C++"; Function = "Sync-CppSdk" }
    "js" = @{ Repo = "croupier-sdk-js"; Name = "JavaScript"; Function = "Sync-JsSdk" }
    "csharp" = @{ Repo = "croupier-sdk-csharp"; Name = "C#"; Function = "Sync-CsharpSdk" }
}
