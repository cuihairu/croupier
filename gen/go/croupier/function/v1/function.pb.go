...
func (x *InvokeRequest) GetIdempotencyKey() string { if x==nil {return ""}; return x.IdempotencyKey }
...
func (x *JobStreamRequest) GetJobId() string { if x==nil {return ""}; return x.JobId }
...
func (x *JobEvent) GetType() string { if x==nil {return ""}; return x.Type }
func (x *JobEvent) GetMessage() string { if x==nil {return ""}; return x.Message }
func (x *JobEvent) GetProgress() int32 { if x==nil {return 0}; return x.Progress }
func (x *JobEvent) GetPayload() []byte { if x==nil {return nil}; return x.Payload }
...
type FunctionServiceServer interface {
    ...
    StartJob(ctx context.Context, req *InvokeRequest) (*StartJobResponse, error)
    StreamJob(req *JobStreamRequest, srv FunctionService_StreamJobServer) error
    CancelJob(ctx context.Context, req *CancelJobRequest) (*StartJobResponse, error)
}
...
func RegisterFunctionServiceServer(s *grpc.Server, srv FunctionServiceServer) {
    s.RegisterService(&grpc.ServiceDesc{
        ...
        Methods: []grpc.MethodDesc{
            {MethodName: "Invoke", Handler: _FunctionService_Invoke_Handler},
            {MethodName: "StartJob", Handler: _FunctionService_StartJob_Handler},
            {MethodName: "CancelJob", Handler: _FunctionService_CancelJob_Handler},
        },
        Streams: []grpc.StreamDesc{
            {StreamName: "StreamJob", Handler: _FunctionService_StreamJob_Handler, ServerStreams: true},
        },
...
func (c *functionServiceClient) StreamJob(ctx context.Context, in *JobStreamRequest, opts ...grpc.CallOption) (FunctionService_StreamJobClient, error) {
    ...
    stream, err := c.cc.NewStream(ctx, desc, "/croupier.function.v1.FunctionService/StreamJob", opts...)
    if err != nil { return nil, err }
