...
const file_croupier_sdk_v1_invoker_proto_rawDesc = "" +
	"\n" +
	"\x1dcroupier/sdk/v1/invoker.proto\x12\x0fcroupier.sdk.v1\"\xfa\x01\n" +
	...
	"\"io.github.cuihairu.croupier.sdk.v1P\x01ZAgithub.com/cuihairu/croupier/pkg/pb/croupier/sdk/v1;sdkv1b\x06proto3"

var (
	file_croupier_sdk_v1_invoker_proto_rawDescOnce sync.Once
	file_croupier_sdk_v1_invoker_proto_rawDescData []byte
)

func file_croupier_sdk_v1_invoker_proto_rawDescGZIP() []byte {
	file_croupier_sdk_v1_invoker_proto_rawDescOnce.Do(func() {
		file_croupier_sdk_v1_invoker_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_croupier_sdk_v1_invoker_proto_rawDesc), len(file_croupier_sdk_v1_invoker_proto_rawDesc)))
	})
...
func file_croupier_sdk_v1_invoker_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_croupier_sdk_v1_invoker_proto_rawDesc), len(file_croupier_sdk_v1_invoker_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
