...
const file_croupier_options_v1_function_options_proto_rawDesc = "" +
	"\n" +
	"*croupier/options/v1/function_options.proto\x12\x13croupier.options.v1\x1a google/protobuf/descriptor.proto\x1a\x1bcroupier/common/v1/ui.proto\"\xb5\x05\n" +
	...
	"\tplacement\x18\b \x01(\tR\tplacement\x12H\n" +
	...
	"\x06entity\x12\x1f.google.protobuf.MessageOptions\x18\xba\x8e\x03 \x01(\v2\".croupier.options.v1.EntityOptionsR\x06entityBm\n" +
	"&io.github.cuihairu.croupier.options.v1P\x01ZAgithub.com/cuihairu/croupier/pkg/pb/croupier/options/v1;optionsv1b\x06proto3"

var (
	file_croupier_options_v1_function_options_proto_rawDescOnce sync.Once
	file_croupier_options_v1_function_options_proto_rawDescData []byte
)
...
func file_croupier_options_v1_function_options_proto_rawDescGZIP() []byte {
	file_croupier_options_v1_function_options_proto_rawDescOnce.Do(func() {
		file_croupier_options_v1_function_options_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_croupier_options_v1_function_options_proto_rawDesc), len(file_croupier_options_v1_function_options_proto_rawDesc)))
	})
...
func file_croupier_options_v1_function_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_croupier_options_v1_function_options_proto_rawDesc), len(file_croupier_options_v1_function_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 2,
			NumServices:   0,
