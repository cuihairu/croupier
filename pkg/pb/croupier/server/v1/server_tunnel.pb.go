...
const file_croupier_server_v1_server_tunnel_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x05 \x03(\v2-.croupier.server.v1.InvokeFrame.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\bmetadata\x18\x05 \x03(\v2/.croupier.server.v1.StartJobFrame.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x05error\x18\x04 \x01(\tR\x05error\"\xd0\x05\n" +
	"\rTunnelMessage\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12/\n" +
	"\x05hello\x18\x02 \x01(\v2\x19.croupier.server.v1.HelloR\x05hello\x127\n" +
	"\x06result\x18\x03 \x01(\v2\x1f.croupier.server.v1.ResultFrameR\x06result\x12;\n" +
	"\astart_r\x18\x04 \x01(\v2\".croupier.server.v1.StartJobResultR\x06startR\x12:\n" +
	"\ajob_evt\x18\x05 \x01(\v2!.croupier.server.v1.JobEventFrameR\x06jobEvt\x12?\n" +
	"\blist_req\x18\x06 \x01(\v2$.croupier.server.v1.ListLocalRequestR\alistReq\x12@\n" +
	"\blist_res\x18\a \x01(\v2%.croupier.server.v1.ListLocalResponseR\alistRes\x12J\n" +
	"\vjob_res_req\x18\b \x01(\v2*.croupier.server.v1.TunnelJobResultRequestR\tjobResReq\x12K\n" +
	"\vjob_res_res\x18\t \x01(\v2+.croupier.server.v1.TunnelJobResultResponseR\tjobResRes\x127\n" +
	"\x06invoke\x18\n" +
	" \x01(\v2\x1f.croupier.server.v1.InvokeFrameR\x06invoke\x127\n" +
	...
	"\x16com.croupier.server.v1B\x11ServerTunnelProtoP\x01Z?github.com/cuihairu/croupier/generated/croupier/server/v1;serverv1\xa2\x02\x03CSX\xaa\x02\x12Croupier.Server.V1\xca\x02\x12Croupier\\Server\\V1\xe2\x02\x1eCroupier\\Server\\V1\\GPBMetadata\xea\x02\x14Croupier::Server::V1b\x06proto3"
