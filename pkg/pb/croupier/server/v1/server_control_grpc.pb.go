...
func (c *controlServiceClient) ListFunctionsSummary(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListFunctionsSummaryResponse, error) {
	...
	err := c.cc.Invoke(ctx, ControlService_ListFunctionsSummary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlServiceClient) RegisterCapabilities(ctx context.Context, in *RegisterCapabilitiesRequest, opts ...grpc.CallOption) (*RegisterCapabilitiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ControlService_RegisterCapabilities_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
