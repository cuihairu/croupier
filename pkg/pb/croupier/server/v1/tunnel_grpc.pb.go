...
const (
	TunnelService_Open_FullMethodName = "/croupier.server.v1.TunnelService/Open"
)
...
type TunnelServiceClient interface {
	...
	Open(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelMessage, TunnelMessage], error)
}
...
func (c *tunnelServiceClient) Open(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelMessage, TunnelMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TunnelService_ServiceDesc.Streams[0], TunnelService_Open_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func _TunnelService_Open_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TunnelServiceServer).Open(&grpc.GenericServerStream[TunnelMessage, TunnelMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TunnelService_OpenServer = grpc.BidiStreamingServer[TunnelMessage, TunnelMessage]
...
var TunnelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "croupier.server.v1.TunnelService",
	...
	Metadata: "croupier/server/v1/tunnel.proto",
}
