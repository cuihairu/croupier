...
- 本轮（2026-08-07）新增前端验证：`cd "web" && pnpm exec eslint "src/pages/OpenAPISources/index.tsx" "src/components/ProposalInbox/index.tsx" "src/services/api/openapi.ts"` 通过；`cd "web" && pnpm exec tsc --noEmit` 通过。
