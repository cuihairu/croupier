...
- Name: dashboard-vnext.spec.ts >> Dashboard PageSpec 验收测试 >> 独立操作 - OperationPage 完整功能
- Location: e2e/dashboard-vnext.spec.ts:124:7
