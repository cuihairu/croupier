...
export default {
  ...
  'pages.pageStudio.editor.dangling.apply': 'Apply reconnect',
  'pages.pageStudio.editor.dangling.keep': 'Keep disconnected',
  'pages.pageStudio.editor.dangling.kind.action': 'Action target',
  'pages.pageStudio.editor.dangling.kind.refresh': 'Refresh dependency',
  'pages.pageStudio.editor.dangling.kind.assignment': 'Param source',
  'pages.pageStudio.editor.dangling.kind.rowAction': 'Row action dialog',
  'pages.pageStudio.editor.dangling.detail.main': 'Main action target',
  'pages.pageStudio.editor.dangling.detail.chain': 'Chain step {n}',
  'pages.pageStudio.editor.dangling.detail.assignment': 'Mapping #{n}',
  'pages.pageStudio.editor.dangling.detail.rowAction': 'Row action #{n}',
