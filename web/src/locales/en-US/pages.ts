export default {
  ...
  // System announcements / broadcast (admin back office, admin-only)
  'pages.announcements.action.delete': 'Delete',
  'pages.announcements.action.edit': 'Edit',
  'pages.announcements.audience.all': 'All users',
  'pages.announcements.audience.role': 'Specific role',
  'pages.announcements.column.actions': 'Actions',
  'pages.announcements.column.audience': 'Audience',
  'pages.announcements.column.flags': 'Flags',
  'pages.announcements.column.title': 'Title',
  'pages.announcements.column.updatedAt': 'Updated',
  'pages.announcements.create': 'Publish announcement',
  'pages.announcements.create.success': 'Announcement published',
  'pages.announcements.delete.confirm': 'Delete this announcement?',
  'pages.announcements.delete.success': 'Announcement deleted',
  'pages.announcements.empty': 'No announcements yet',
  'pages.announcements.error.delete': 'Failed to delete the announcement',
  'pages.announcements.error.load': 'Failed to load announcements',
  'pages.announcements.error.save': 'Failed to save the announcement',
  'pages.announcements.field.active': 'Effective immediately',
  ...
  'pages.announcements.field.range': 'Active time range (optional)',
  'pages.announcements.field.role': 'Role name',
  'pages.announcements.field.role.required': 'Please enter the role name',
  'pages.announcements.field.title': 'Title',
  'pages.announcements.field.title.placeholder': 'Summarize the announcement in one sentence',
  'pages.announcements.field.title.required': 'Please enter a title',
  'pages.announcements.flag.active': 'Active',
  'pages.announcements.flag.inactive': 'Disabled',
  'pages.announcements.flag.popup': 'Popup',
  'pages.announcements.modal.cancel': 'Cancel',
  'pages.announcements.modal.create': 'Publish announcement',
  'pages.announcements.modal.edit': 'Edit announcement',
  'pages.announcements.modal.ok': 'Save',
  'pages.announcements.subtitle':
    'Announcements for all users or a specific role. They are served through the user-side /announcements/active endpoint; popup announcements are confirmed after sign-in.',
  'pages.announcements.title': 'System announcements / broadcast',
