export default {
  ...
  'pages.login.mfa.hint': '两步验证已开启，请输入认证器 App 中的 6 位动态验证码',
  'pages.login.mfa.placeholder': '动态验证码（6 位）',
  'pages.login.mfa.required': '请输入动态验证码!',
  'pages.login.mfa.required.info': '该账号已启用两步验证，请输入动态验证码',
