export default {
  ...
  'profile.permissions.fallback.pages.edit.name': '页面编辑权限',
  'profile.permissions.fallback.pages.edit.description': '允许编辑和保存 PageSpec 草稿',
  'profile.permissions.fallback.pages.publish.name': '页面发布权限',
  'profile.permissions.fallback.pages.publish.description': '允许发布或取消发布 PageSpec',
  'profile.permissions.fallback.pages.rollback.name': '页面回滚权限',
  'profile.permissions.fallback.pages.rollback.description': '允许页面版本回滚操作',
  ...
  // 系统公告 / 广播（管理后台，admin-only）
  'pages.announcements.action.delete': '删除',
  'pages.announcements.action.edit': '编辑',
  'pages.announcements.audience.all': '全体用户',
  'pages.announcements.audience.role': '指定角色',
  'pages.announcements.column.actions': '操作',
  'pages.announcements.column.audience': '受众',
  'pages.announcements.column.flags': '标记',
  'pages.announcements.column.title': '标题',
  'pages.announcements.column.updatedAt': '更新时间',
  'pages.announcements.create': '发布公告',
  'pages.announcements.create.success': '公告已发布',
  'pages.announcements.delete.confirm': '确认删除该公告？',
  'pages.announcements.delete.success': '公告已删除',
  'pages.announcements.empty': '还没有公告',
  'pages.announcements.error.delete': '删除公告失败',
  'pages.announcements.error.load': '加载公告失败',
  'pages.announcements.error.save': '保存公告失败',
  'pages.announcements.field.active': '立即生效',
  ...
  'pages.announcements.field.range': '生效时间区间（可选）',
  'pages.announcements.field.role': '角色名',
  'pages.announcements.field.role.required': '请填写角色名',
  'pages.announcements.field.title': '标题',
  'pages.announcements.field.title.placeholder': '一句话说清公告主题',
  'pages.announcements.field.title.required': '请填写标题',
  'pages.announcements.flag.active': '生效中',
  'pages.announcements.flag.inactive': '已停用',
  'pages.announcements.flag.popup': '弹窗提示',
  'pages.announcements.modal.cancel': '取消',
  'pages.announcements.modal.create': '发布公告',
  'pages.announcements.modal.edit': '编辑公告',
  'pages.announcements.modal.ok': '保存',
  'pages.announcements.subtitle':
    '面向全体用户或指定角色的公告。公告通过用户侧 /announcements/active 下发，弹窗型公告在用户登录后提示确认。',
  'pages.announcements.title': '系统公告 / 广播',
  'pages.announcements.update.success': '公告已更新',
  // 消息通知 Tab ②：通知渠道偏好
  'profile.channel.cardTitle': '通知渠道偏好',
  'profile.channel.readonly.hint': '当前为平台级设置，暂不支持按个人修改',
