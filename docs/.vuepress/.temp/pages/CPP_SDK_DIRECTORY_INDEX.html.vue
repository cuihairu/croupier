<template><div><h1 id="croupier-c-sdk-目录索引与文件映射" tabindex="-1"><a class="header-anchor" href="#croupier-c-sdk-目录索引与文件映射"><span>Croupier C++ SDK 目录索引与文件映射</span></a></h1>
<h2 id="📦-完整目录结构" tabindex="-1"><a class="header-anchor" href="#📦-完整目录结构"><span>📦 完整目录结构</span></a></h2>
...
<h2 id="🎯-按功能查找代码" tabindex="-1"><a class="header-anchor" href="#🎯-按功能查找代码"><span>🎯 按功能查找代码</span></a></h2>
<h3 id="🔴-spi-service-provider-interface" tabindex="-1"><a class="header-anchor" href="#🔴-spi-service-provider-interface"><span>🔴 SPI (Service Provider Interface)</span></a></h3>
<table>
<thead>
<tr>
<th>功能</th>
...
<div class="language-cpp line-numbers-mode" data-highlighter="prismjs" data-ext="cpp"><pre v-pre><code class="language-cpp"><span class="line"><span class="token comment">// 定义 (line 18)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h3 id="🟢-game-id-和-env" tabindex="-1"><a class="header-anchor" href="#🟢-game-id-和-env"><span>🟢 game_id 和 env</span></a></h3>
<table>
<thead>
<tr>
<th>功能</th>
...
<tbody>
<tr>
<td>ClientConfig 定义</td>
<td>croupier_client.h</td>
<td>57-83</td>
</tr>
<tr>
<td>game_id/env 字段</td>
<td>croupier_client.h</td>
<td>65-66, 90-91</td>
</tr>
<tr>
...
<p><strong>关键代码片段</strong>：</p>
<div class="language-cpp line-numbers-mode" data-highlighter="prismjs" data-ext="cpp"><pre v-pre><code class="language-cpp"><span class="line"><span class="token comment">// 配置 (lines 65-66, 90-91)</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h3 id="🔵-与-agent-交互" tabindex="-1"><a class="header-anchor" href="#🔵-与-agent-交互"><span>🔵 与 Agent 交互</span></a></h3>
<table>
<thead>
<tr>
<th>功能</th>
...
<p><strong>关键代码片段</strong>：</p>
<div class="language-cpp line-numbers-mode" data-highlighter="prismjs" data-ext="cpp"><pre v-pre><code class="language-cpp"><span class="line"><span class="token comment">// 步骤1：连接 Agent (line 317)</span></span>
...
<span class="line">    <span class="token comment">// NOTE: Agent gRPC 注册功能待实现</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Proto 消息</strong> (local.proto):</p>
<div class="language-protobuf line-numbers-mode" data-highlighter="prismjs" data-ext="protobuf"><pre v-pre><code class="language-protobuf"><span class="line"><span class="token keyword">message</span> <span class="token class-name">RegisterLocalRequest</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h3 id="🟣-权限接口" tabindex="-1"><a class="header-anchor" href="#🟣-权限接口"><span>🟣 权限接口</span></a></h3>
<table>
<thead>
<tr>
<th>功能</th>
...
<p><strong>关键代码片段</strong>：</p>
<div class="language-cpp line-numbers-mode" data-highlighter="prismjs" data-ext="cpp"><pre v-pre><code class="language-cpp"><span class="line"><span class="token comment">// 认证配置 (lines 70-78)</span></span>
<span class="line"><span class="token keyword">struct</span> <span class="token class-name">ClientConfig</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="📍-关键类和方法定位" tabindex="-1"><a class="header-anchor" href="#📍-关键类和方法定位"><span>📍 关键类和方法定位</span></a></h2>
<h3 id="croupierclient-核心方法" tabindex="-1"><a class="header-anchor" href="#croupierclient-核心方法"><span>CroupierClient 核心方法</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">文件: croupier_client.h/cpp</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="impl-内部实现" tabindex="-1"><a class="header-anchor" href="#impl-内部实现"><span>Impl 内部实现</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">文件: croupier_client.cpp</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="🔧-常用代码片段位置" tabindex="-1"><a class="header-anchor" href="#🔧-常用代码片段位置"><span>🔧 常用代码片段位置</span></a></h2>
<table>
<thead>
<tr>
<th>用途</th>
...
<td>croupier_client.cpp</td>
<td>677-718</td>
<td>ValidateObjectDescriptor()</td>
</tr>
<tr>
<td>组件验证</td>
<td>croupier_client.cpp</td>
<td>721-750</td>
<td>ValidateComponentDescriptor()</td>
</tr>
<tr>
<td>模板生成</td>
<td>croupier_client.cpp</td>
<td>753-793</td>
<td>GenerateXxxTemplate()</td>
</tr>
</tbody>
</table>
<hr>
<h2 id="📚-文档导航" tabindex="-1"><a class="header-anchor" href="#📚-文档导航"><span>📚 文档导航</span></a></h2>
<h3 id="用户文档" tabindex="-1"><a class="header-anchor" href="#用户文档"><span>用户文档</span></a></h3>
<ul>
<li><strong>README.md</strong>: 快速开始、示例、API 参考</li>
<li><strong>VIRTUAL_OBJECT_REGISTRATION.md</strong>: 架构设计、四层模型、DDD 模式</li>
</ul>
<h3 id="技术分析" tabindex="-1"><a class="header-anchor" href="#技术分析"><span>技术分析</span></a></h3>
<ul>
<li><strong>CPP_SDK_DEEP_ANALYSIS.md</strong>: 深度分析（新）</li>
<li><strong>CPP_SDK_QUICK_REFERENCE.md</strong>: 快速参考表（新）</li>
<li><strong>CPP_SDK_DIRECTORY_INDEX.md</strong>: 本文档（目录索引）</li>
</ul>
<h3 id="示例代码" tabindex="-1"><a class="header-anchor" href="#示例代码"><span>示例代码</span></a></h3>
<ul>
<li><strong>virtual_object_demo.cpp</strong>: 6 个完整演示</li>
</ul>
<h3 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h3>
<ul>
<li><strong>CMakeLists.txt</strong>: 构建系统</li>
<li><strong>vcpkg.json</strong>: 依赖管理</li>
<li><strong>.github/workflows/cpp-sdk-build.yml</strong>: CI/CD 自动化</li>
</ul>
<hr>
<h2 id="🔍-快速查询表" tabindex="-1"><a class="header-anchor" href="#🔍-快速查询表"><span>🔍 快速查询表</span></a></h2>
<h3 id="我要" tabindex="-1"><a class="header-anchor" href="#我要"><span>&quot;我要...&quot;</span></a></h3>
<table>
<thead>
<tr>
<th>需求</th>
