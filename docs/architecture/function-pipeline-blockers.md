...
### R1 [同名函数跨注册方 latest-wins，无冲突检测（高]
...
### R2 [HA 下 survivingFunctionMeta 是实例本地内存视图（中]
...
### U4 [versioning「重新生成」对 composite 页语义错位（中]
