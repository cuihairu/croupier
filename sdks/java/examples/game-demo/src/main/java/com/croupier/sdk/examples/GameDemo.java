...
public class GameDemo {
    ...
    static void registerAll(CroupierClient client, DemoStore store) throws CroupierException {
        ...
        List<Fn> fns = List.of(
            ...
            new Fn("player.delete", "danger", "player", "delete", "delete", "sync", "player.delete.double_check", playerDelete(store)),
            ...
            new Fn("order.delete", "danger", "order", "delete", "delete", "sync", "order.delete.double_check", orderDelete(store)),
            ...
            new Fn("leaderboard.reset", "danger", "leaderboard", "reset", "action", "sync", "leaderboard.reset.double_check", leaderboardReset(store)),
