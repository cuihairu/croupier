...
def enrich_descriptor(desc: FunctionDescriptor) -> FunctionDescriptor:
    ...
    if not desc.summary:
        desc.summary = f"{desc.resource} {desc.operation}"
...
def main() -> None:
    ...
    fns = [
        ...
        ("player.delete", "player", "danger", "delete", "delete", "sync", "player.delete.double_check", make_player_delete(store)),
        ...
        ("order.delete", "order", "danger", "delete", "delete", "sync", "order.delete.double_check", make_order_delete(store)),
        ...
        ("leaderboard.reset", "leaderboard", "danger", "reset", "action", "sync", "leaderboard.reset.double_check", make_leaderboard_reset(store)),
