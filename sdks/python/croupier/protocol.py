...
MSG_GET_JOB_RESULT_REQUEST = 0x020107
MSG_GET_JOB_RESULT_RESPONSE = 0x020108

# InvokerService (0x03xx)
MSG_INVOKE_REQUEST = 0x030101
MSG_INVOKE_RESPONSE = 0x030102
MSG_START_JOB_REQUEST = 0x030103
MSG_START_JOB_RESPONSE = 0x030104
MSG_STREAM_JOB_REQUEST = 0x030105
MSG_JOB_EVENT = 0x030106
MSG_CANCEL_JOB_REQUEST = 0x030107
MSG_CANCEL_JOB_RESPONSE = 0x030108
...
# LocalControlService (0x05xx) - Provider session (SDK <-> Agent)
MSG_REGISTER_LOCAL_REQUEST = 0x050101
MSG_REGISTER_LOCAL_RESPONSE = 0x050102
MSG_HEARTBEAT_LOCAL_REQUEST = 0x050103
MSG_HEARTBEAT_LOCAL_RESPONSE = 0x050104
MSG_LIST_LOCAL_REQUEST = 0x050109
MSG_LIST_LOCAL_RESPONSE = 0x05010A

# New-style aliases (Provider session semantics)
MSG_PROVIDER_CONNECT_REQUEST = MSG_REGISTER_LOCAL_REQUEST
MSG_PROVIDER_CONNECT_RESPONSE = MSG_REGISTER_LOCAL_RESPONSE
MSG_PROVIDER_HEARTBEAT_REQUEST = MSG_HEARTBEAT_LOCAL_REQUEST
MSG_PROVIDER_HEARTBEAT_RESPONSE = MSG_HEARTBEAT_LOCAL_RESPONSE
