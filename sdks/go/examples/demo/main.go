...
func gameDemoFunctionDefinitions(store *demoStore) []demoFunctionDefinition {
	return []demoFunctionDefinition{
		...
		{croupier.FunctionDescriptor{ID: "player.delete", Version: "1.0.0", Resource: "player", Operation: "delete", Capability: "delete", Execution: "sync", Risk: "danger", Enabled: true, ApprovalRequired: true, ApprovalPolicyKey: "player.delete.double_check", InputSchema: `{"type":"object","properties":{"id":{"type":"string"}},"required":["id"]}`, OutputSchema: deleteSchema}, store.playerDelete},
		...
		{croupier.FunctionDescriptor{ID: "order.delete", Version: "1.0.0", Resource: "order", Operation: "delete", Capability: "delete", Execution: "sync", Risk: "danger", Enabled: true, ApprovalRequired: true, ApprovalPolicyKey: "order.delete.double_check", InputSchema: `{"type":"object","properties":{"id":{"type":"string"}},"required":["id"]}`, OutputSchema: deleteSchema}, store.orderDelete},
		...
		{croupier.FunctionDescriptor{ID: "leaderboard.reset", Version: "1.0.0", Resource: "leaderboard", Operation: "reset", Capability: "action", Execution: "sync", Risk: "danger", Enabled: true, ApprovalRequired: true, ApprovalPolicyKey: "leaderboard.reset.double_check", InputSchema: `{"type":"object","properties":{}}`, OutputSchema: resetSchema}, store.leaderboardReset},
