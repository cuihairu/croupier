...
func (c *client) convertToLocalFunctions() []LocalFunctionDescriptor {
	...
	for funcID := range c.handlers {
		...
		localDesc := LocalFunctionDescriptor{
			...
			CategoryDisplay:  desc.CategoryDisplay,
			EntityDisplay:    desc.EntityDisplay,
			OperationDisplay: desc.OperationDisplay,
			OperationKind:    desc.OperationKind,
			Placement:        desc.Placement,
			PageHint:         desc.PageHint,
