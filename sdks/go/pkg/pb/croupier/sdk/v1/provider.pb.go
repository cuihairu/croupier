...
type ProviderConnectRequest struct {
	...
	// User-defined instance metadata (multiple key-value pairs, Nacos-style).
	// e.g. {"serverId": "s1", "pod": "game-7c4d"}. Surfaced verbatim on the
	// SDK distribution page; agent drops keys colliding with reserved built-ins
	// (sdkLanguage/sdkVersion/sdkName/gameId/env/protocol_version).
...
func (x *ProviderConnectRequest) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
const file_croupier_sdk_v1_provider_proto_rawDesc = "" +
	...
	"\x13approval_policy_key\x18\x12 \x01(\tR\x11approvalPolicyKey\"\x83\x05\n" +
	...
	"\x03env\x18\f \x01(\tR\x03env\x12Q\n" +
	"\bmetadata\x18\r \x03(\v25.croupier.sdk.v1.ProviderConnectRequest.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\x05error\x18\x03 \x01(\tR\x05errorBi\n" +
...
var file_croupier_sdk_v1_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_croupier_sdk_v1_provider_proto_goTypes = []any{
	...
	nil,                                // 9: croupier.sdk.v1.ProviderConnectRequest.MetadataEntry
}
var file_croupier_sdk_v1_provider_proto_depIdxs = []int32{
	...
	9, // 1: croupier.sdk.v1.ProviderConnectRequest.metadata:type_name -> croupier.sdk.v1.ProviderConnectRequest.MetadataEntry
