...
type FunctionDescriptor struct {
	...
	Resource   string                 `protobuf:"bytes,3,opt,name=resource,proto3" json:"resource,omitempty"`     // business resource/capability key, e.g. "player"
	Operation  string                 `protobuf:"bytes,4,opt,name=operation,proto3" json:"operation,omitempty"`   // business action key, e.g. "ban", "send", "list"
...
func (x *FunctionDescriptor) GetResource() string {
	if x != nil {
		return x.Resource
	}
	return ""
...
func (x *FunctionDescriptor) GetPermission() string {
	if x != nil {
		return x.Permission
	}
	return ""
...
type AgentProcess struct {
	...
	// Provider-declared user metadata (verbatim forward of ProviderConnectRequest
	// metadata minus reserved built-ins). Observability only — never routing.
...
func (x *AgentProcess) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *HeartbeatRequest) GetOwnerInstanceId() string {
	if x != nil {
...
const file_croupier_agent_v1_register_proto_rawDesc = "" +
	...
	"\routput_schema\x18\x1f \x01(\tR\foutputSchema\"\xb6\x03\n" +
	...
	"\x03env\x18\n" +
	" \x01(\tR\x03env\x12I\n" +
	"\bmetadata\x18\v \x03(\v2-.croupier.agent.v1.AgentProcess.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x04\x10\x05R\brpc_addr\"\x8b\x01\n" +
	...
	"\x11owner_instance_id\x18\x03 \x01(\tR\x0fownerInstanceId\"\x13\n" +
...
var file_croupier_agent_v1_register_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_croupier_agent_v1_register_proto_goTypes = []any{
	...
	nil,                                  // 9: croupier.agent.v1.AgentProcess.MetadataEntry
	nil,                                  // 10: croupier.agent.v1.RegisterRequest.LabelsEntry
}
var file_croupier_agent_v1_register_proto_depIdxs = []int32{
	9,  // 0: croupier.agent.v1.AgentProcess.metadata:type_name -> croupier.agent.v1.AgentProcess.MetadataEntry
	0,  // 1: croupier.agent.v1.RegisterRequest.functions:type_name -> croupier.agent.v1.FunctionDescriptor
	1,  // 2: croupier.agent.v1.RegisterRequest.processes:type_name -> croupier.agent.v1.AgentProcess
	10, // 3: croupier.agent.v1.RegisterRequest.labels:type_name -> croupier.agent.v1.RegisterRequest.LabelsEntry
	6,  // 4: croupier.agent.v1.RegisterCapabilitiesRequest.provider:type_name -> croupier.agent.v1.ProviderMeta
