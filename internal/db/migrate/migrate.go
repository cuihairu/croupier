...
// 0004 enum columns; 0005 game-support context columns; 0006 bug tracker; 0007 tool registry; 0008 game release; 0009 config namespace
// (Go migrations registered in internal/svc/migrations.go).
const MinimumRequiredVersion int64 = 9
