...
func TestEnsureUpToDate_FreshDatabaseRunsBaselineAndMigrations(t *testing.T) {
	...
	fsys := mapFS(map[string]string{
		...
		"0015_add_probe15.sql": "-- +goose Up\nCREATE TABLE probe15 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe15;\n",
		"0016_add_probe16.sql": "-- +goose Up\nCREATE TABLE probe16 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe16;\n",
		"0017_add_probe17.sql": "-- +goose Up\nCREATE TABLE probe17 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe17;\n",
		"0018_add_probe18.sql": "-- +goose Up\nCREATE TABLE probe18 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe18;\n",
		"0019_add_probe19.sql": "-- +goose Up\nCREATE TABLE probe19 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe19;\n",
		"0020_add_probe20.sql": "-- +goose Up\nCREATE TABLE probe20 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe20;\n",
		"0021_add_probe21.sql": "-- +goose Up\nCREATE TABLE probe21 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe21;\n",
		"0022_add_probe22.sql": "-- +goose Up\nCREATE TABLE probe22 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe22;\n",
		"0023_add_probe23.sql": "-- +goose Up\nCREATE TABLE probe23 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe23;\n",
		"0024_add_probe24.sql": "-- +goose Up\nCREATE TABLE probe24 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe24;\n",
		"0025_add_probe25.sql": "-- +goose Up\nCREATE TABLE probe25 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe25;\n",
		"0026_add_probe26.sql": "-- +goose Up\nCREATE TABLE probe26 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe26;\n",
		"0027_add_probe27.sql": "-- +goose Up\nCREATE TABLE probe27 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe27;\n",
		"0028_add_probe28.sql": "-- +goose Up\nCREATE TABLE probe28 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe28;\n",
		"0029_add_probe29.sql": "-- +goose Up\nCREATE TABLE probe29 (id INTEGER PRIMARY KEY);\n\n-- +goose Down\nDROP TABLE probe29;\n",
	...
	for _, table := range []string{"probe2", "probe3", "probe4", "probe5", "probe6", "probe7", "probe8", "probe9", "probe10", "probe11", "probe12", "probe13", "probe14", "probe15"} {
...
func TestEnsureUpToDate_LegacyDatabaseBridgesOnceThenCatchesUp(t *testing.T) {
	...
	// 与 MinimumRequiredVersion 同步：新增迁移时两者一起变
	if version != MinimumRequiredVersion {
		t.Fatalf("version = %d, want %d", version, MinimumRequiredVersion)
	}
}
