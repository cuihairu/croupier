...
func TestFunctionHandlersRejectMalformedJSON(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "FunctionUI", fn: h.FunctionUI},
		{name: "FunctionUIUpdate", fn: h.FunctionUIUpdate},
		{name: "FunctionUIHistory", fn: h.FunctionUIHistory},
		{name: "FunctionUIRollback", fn: h.FunctionUIRollback},
