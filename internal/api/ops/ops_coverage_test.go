...
func TestHandlerAliasAgentMethods(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "NodeDrain", method: http.MethodPost, url: "/api/v1/ops/node/drain", body: `{"nodeId":"agent-1"}`, fn: h.NodeDrain, statusCode: http.StatusInternalServerError},
		{name: "NodeRestart", method: http.MethodPost, url: "/api/v1/ops/node/restart", body: `{"nodeId":"agent-1"}`, fn: h.NodeRestart, statusCode: http.StatusInternalServerError},
		{name: "NodeUndrain", method: http.MethodPost, url: "/api/v1/ops/node/undrain", body: `{"nodeId":"agent-1"}`, fn: h.NodeUndrain, statusCode: http.StatusInternalServerError},
