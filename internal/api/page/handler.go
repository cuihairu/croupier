...
// ListDrafts handles GET /api/v1/workspaces/pages
...
// GetDraft handles GET /api/v1/workspaces/pages/:pageKey
...
// SaveDraft handles PUT /api/v1/workspaces/pages/:pageKey
...
// Validate handles POST /api/v1/workspaces/pages/:pageKey/validate
...
// Preview handles POST /api/v1/workspaces/pages/:pageKey/preview
...
// Publish handles POST /api/v1/workspaces/pages/:pageKey/publish
...
// Unpublish handles POST /api/v1/workspaces/pages/:pageKey/unpublish
...
// Versions handles GET /api/v1/workspaces/pages/:pageKey/versions
...
// VersionDetail handles GET /api/v1/workspaces/pages/:pageKey/versions/:versionId
...
// Rollback handles POST /api/v1/workspaces/pages/:pageKey/rollback
