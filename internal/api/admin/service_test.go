...
func TestService_List_Success(t *testing.T) {
	...
	// Create test admins
	admin1ID := createTestAdminWithRole(t, db, "admin1", "Password@123", "admin")
	admin2ID := createTestAdminWithRole(t, db, "admin2", "Password@123", "admin")

	ctx, adminID := createTestAdminWithContext(t, db, "superadmin", "Password@123", "admin")
	_ = admin1ID
	_ = admin2ID
...
func TestService_List_WithSearch(t *testing.T) {
	...
	createTestAdminWithRole(t, db, "john_doe", "Password@123", "admin")
	createTestAdminWithRole(t, db, "jane_smith", "Password@123", "admin")
	createTestAdminWithRole(t, db, "bob_wilson", "Password@123", "admin")

	ctx, _ := createTestAdminWithContext(t, db, "superadmin", "Password@123", "admin")
...
func TestService_List_WithStatusFilter(t *testing.T) {
	...
	err := adminModel.Create(context.Background(), activeAdmin, "Password@123")
	require.NoError(t, err)
	...
	err = adminModel.Create(context.Background(), disabledAdmin, "Password@123")
	require.NoError(t, err)
...
func TestService_Get_Success(t *testing.T) {
	...
	adminID := createTestAdminWithRole(t, db, "testadmin", "Password@123", "admin")
...
func TestService_PasswordReset_Success(t *testing.T) {
	...
	_, err = adminModel.ValidatePassword(context.Background(), "testadmin", "Password@123")
	assert.Error(t, err)
...
func TestService_List_Pagination(t *testing.T) {
	...
	for i := 1; i <= 25; i++ {
		createTestAdminWithRole(t, db, "pagination_admin"+strconv.FormatUint(uint64(i), 10), "Password@123", "admin")
	}

	ctx, _ := createTestAdminWithContext(t, db, "pagination_superadmin", "Password@123", "admin")
...
func Test_Debug_AdminModelList(t *testing.T) {
	...
	err := svcCtx.AdminModel.Create(context.Background(), admin, "Password@123")
	require.NoError(t, err)
...
func Test_Debug_GetAdminRoles(t *testing.T) {
	...
	adminID := createTestAdminWithRole(t, db, "testadmin3", "Password@123", "admin")
